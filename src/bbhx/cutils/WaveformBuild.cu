...
// static: WaveformBuild.cu and SpecialLikelihood.cu each carry these two
// helpers and both TUs link into the single cbbhx module -- internal
// linkage avoids an nvlink multiple-definition error.
